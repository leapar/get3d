...
THREE.GLTFLoader = ( function () {
	...
	GLTFLoader.prototype = {
		...
		load: function ( url, onLoad, onProgress, onError ) {
			...
			loader.load( url, function ( data ) {
				...
				try {
					...
					scope.parse( data, path, onLoad, onError,onProgress );
		...
		parse: function ( data, path, onLoad, onError ,onProgress ) {
	...
	GLTFParser.prototype.loadBufferView = function ( bufferViewIndex ) {
		...
		if(this.json.asset.encrypt){

                var key = CryptoJS.enc.Utf8.parse("daspatialddaasss");
                var buffer_decrypt = CryptoJS.AES.decrypt(bufferViewDef.buffer.toString(), key, {
                    mode: CryptoJS.mode.ECB,
                    padding: CryptoJS.pad.Pkcs7
                })

                var buffer = CryptoJS.enc.Utf8.stringify(buffer_decrypt).toString()

                var byteLength_decrypt = CryptoJS.AES.decrypt(bufferViewDef.byteLength, key, {
                    mode: CryptoJS.mode.ECB,
                    padding: CryptoJS.pad.Pkcs7
                });
                var byteLength = CryptoJS.enc.Utf8.stringify(byteLength_decrypt).toString()

                var byteOffset_decrypt = CryptoJS.AES.decrypt(bufferViewDef.byteOffset, key, {
                    mode: CryptoJS.mode.ECB,
                    padding: CryptoJS.pad.Pkcs7
                });
                var byteOffset = CryptoJS.enc.Utf8.stringify(byteOffset_decrypt).toString()

                bufferViewDef = {buffer: parseInt(buffer) , byteLength:  parseInt(byteLength), byteOffset:  parseInt(byteOffset)}
		}
